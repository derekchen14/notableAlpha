...
describe "User pages" do
  ...
  describe "profile page" do
    ...
    let!(:m1) { FactoryGirl.create(:note, user: user, content: "Foo") }
    let!(:m2) { FactoryGirl.create(:note, user: user, content: "Bar") }
  ...
  describe "index" do
    ...
    it { should have_selector('h1',    text: 'All Notable Users') }
